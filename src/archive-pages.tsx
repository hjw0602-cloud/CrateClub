...
function CrateprintPreview({ board, catalog = releases, compact = false, onTitleChange, onDescriptionChange }: { board: Crateprint; catalog?: typeof releases; compact?: boolean; onTitleChange?: (value: string) => void; onDescriptionChange?: (value: string) => void }) {
