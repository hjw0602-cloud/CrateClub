...
export function CreatePage() {
  ...
  return <div className="create-page section-wrap">
    ...
    </section><aside className="create-preview"><div className="preview-head"><div><span>LIVE PREVIEW</span><b>{templateLabels[template]}</b></div></div><CrateprintPreview board={board} onTitleChange={setTitle} onDescriptionChange={setDescription} /><p>제목과 설명은 포스터 위에서 직접 클릭해 수정할 수 있습니다.</p></aside></div>
  </div>
}
...
function CrateprintPreview({ board, compact = false, onTitleChange, onDescriptionChange }: { board: Crateprint; compact?: boolean; onTitleChange?: (value: string) => void; onDescriptionChange?: (value: string) => void }) {
